# [ADR-0067] Use MongoDB for data-ingestion
...
We will use Node.js for our data-ingestion needs. This technology provides the features we need and aligns with our team's expertise.
