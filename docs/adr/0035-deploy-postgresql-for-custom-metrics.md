# [ADR-0035] Deploy PostgreSQL for custom-metrics
...
| Date        | 2023-04-01 |
| Status      | Accepted |
| Deciders    | Grace Lee, David Kim, Jack Anderson |
...
We will use JWT for our custom-metrics needs. This technology provides the features we need and aligns with our team's expertise.
