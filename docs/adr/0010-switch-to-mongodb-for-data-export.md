# [ADR-0010] Switch-to MongoDB for data-export
...
| Date        | 2025-01-02 |
| Status      | Accepted |
| Deciders    | Carol Johnson, David Kim, Jack Anderson |

## Context

Our data-export implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use TypeScript for our data-export needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for data-export
