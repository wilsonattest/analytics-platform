# [ADR-0042] Implement Redis for query-optimization
...
| Date        | 2025-04-06 |
| Status      | Accepted |
| Deciders    | Henry Brown, Eva Martinez, Frank Wilson |
...
We will use AWS-Lambda for our query-optimization needs. This technology provides the features we need and aligns with our team's expertise.
