# [ADR-0012] Integrate Elasticsearch for dashboard-design
...
| Date        | 2025-05-22 |
| Status      | Proposed |
| Deciders    | Jack Anderson, Grace Lee |

## Context

Our dashboard-design implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Elasticsearch for our dashboard-design needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for dashboard-design
