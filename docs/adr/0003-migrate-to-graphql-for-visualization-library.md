# [ADR-0003] Migrate-to GraphQL for visualization-library
...
| Date        | 2024-02-15 |
| Status      | Proposed |
| Deciders    | Iris Taylor, Alice Chen |

## Context

Our visualization-library implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use OpenID-Connect for our visualization-library needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for visualization-library
...
### Alternative 2: Use Anti-Corruption-Layer

We evaluated using Anti-Corruption-Layer. This was not chosen because it added unnecessary complexity for our use case.
