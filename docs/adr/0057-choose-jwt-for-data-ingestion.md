# [ADR-0057] Choose JWT for data-ingestion
...
We will use MongoDB for our data-ingestion needs. This technology provides the features we need and aligns with our team's expertise.
