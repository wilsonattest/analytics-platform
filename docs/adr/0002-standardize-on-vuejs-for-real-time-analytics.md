# [ADR-0002] Standardize-on Vue.js for real-time-analytics
...
| Date        | 2024-12-09 |
| Status      | Accepted |
| Deciders    | Eva Martinez, Eva Martinez, Carol Johnson |
...
We will use OAuth-2.0 for our real-time-analytics needs. This technology provides the features we need and aligns with our team's expertise.
