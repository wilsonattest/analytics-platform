# [ADR-0016] Migrate-to Vue.js for real-time-analytics
...
| Date        | 2023-12-05 |
| Status      | Superseded |
| Deciders    | Frank Wilson, David Kim, Frank Wilson |

## Context

Our real-time-analytics implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use AWS-Lambda for our real-time-analytics needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for real-time-analytics
...
### Alternative 2: Use Event-Sourcing

We evaluated using Event-Sourcing. This was not chosen because it added unnecessary complexity for our use case.
