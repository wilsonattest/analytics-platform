# [ADR-0054] Adopt REST-API for custom-metrics
...
We will use GraphQL for our custom-metrics needs. This technology provides the features we need and aligns with our team's expertise.
