# [ADR-0069] Integrate Terraform for event-tracking
...
| Date        | 2025-08-30 |
| Status      | Accepted |
| Deciders    | Bob Smith, Iris Taylor, Iris Taylor |

## Context

Our event-tracking implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use HashiCorp-Vault for our event-tracking needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for event-tracking
