# [ADR-0052] Use GraphQL for event-tracking
...
| Date        | 2023-07-21 |
| Status      | Superseded |
| Deciders    | Bob Smith, Eva Martinez, Iris Taylor |
...
We will use OpenID-Connect for our event-tracking needs. This technology provides the features we need and aligns with our team's expertise.
