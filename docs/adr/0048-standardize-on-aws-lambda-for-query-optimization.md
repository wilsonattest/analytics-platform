# [ADR-0048] Standardize-on AWS-Lambda for query-optimization
...
We will use Node.js for our query-optimization needs. This technology provides the features we need and aligns with our team's expertise.
