# [ADR-0034] Migrate-to OAuth-2.0 for etl-pipeline
...
| Date        | 2025-01-10 |
| Status      | Superseded |
| Deciders    | Alice Chen, Alice Chen |

## Context

Our etl-pipeline implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Kafka for our etl-pipeline needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for etl-pipeline
