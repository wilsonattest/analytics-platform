# [ADR-0030] Integrate OpenID-Connect for report-generation
...
We will use Kubernetes for our report-generation needs. This technology provides the features we need and aligns with our team's expertise.
