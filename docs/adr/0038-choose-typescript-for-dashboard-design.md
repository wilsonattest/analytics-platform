# [ADR-0038] Choose TypeScript for dashboard-design
...
| Date        | 2024-04-22 |
| Status      | Proposed |
| Deciders    | Eva Martinez, Jack Anderson, Carol Johnson |
...
We will use DotNet-Core for our dashboard-design needs. This technology provides the features we need and aligns with our team's expertise.
