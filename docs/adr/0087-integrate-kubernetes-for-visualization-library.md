# [ADR-0087] Integrate Kubernetes for visualization-library
...
| Date        | 2024-11-07 |
| Status      | Accepted |
| Deciders    | Bob Smith, Alice Chen, Alice Chen |
...
We will use Kubernetes for our visualization-library needs. This technology provides the features we need and aligns with our team's expertise.
