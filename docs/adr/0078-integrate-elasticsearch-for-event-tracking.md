# [ADR-0078] Integrate Elasticsearch for event-tracking
...
| Date        | 2024-09-21 |
| Status      | Accepted |
| Deciders    | David Kim, Iris Taylor, Henry Brown |
...
We will use GraphQL for our event-tracking needs. This technology provides the features we need and aligns with our team's expertise.
