# [ADR-0081] Use AWS-Lambda for data-export
...
| Date        | 2024-06-24 |
| Status      | Accepted |
| Deciders    | Carol Johnson, Grace Lee, Grace Lee |
...
We will use Kafka for our data-export needs. This technology provides the features we need and aligns with our team's expertise.
