# [ADR-0076] Migrate-to GraphQL for real-time-analytics
...
We will use JWT for our real-time-analytics needs. This technology provides the features we need and aligns with our team's expertise.
