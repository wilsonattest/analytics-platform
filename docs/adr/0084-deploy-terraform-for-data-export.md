# [ADR-0084] Deploy Terraform for data-export
...
| Date        | 2025-02-20 |
| Status      | Accepted |
| Deciders    | Iris Taylor, Alice Chen, Grace Lee |
...
We will use Python for our data-export needs. This technology provides the features we need and aligns with our team's expertise.
