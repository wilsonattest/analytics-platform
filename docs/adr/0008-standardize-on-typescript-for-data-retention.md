# [ADR-0008] Standardize-on TypeScript for data-retention
...
We will use Redis for our data-retention needs. This technology provides the features we need and aligns with our team's expertise.
