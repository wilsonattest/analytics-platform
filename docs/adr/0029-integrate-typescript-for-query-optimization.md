# [ADR-0029] Integrate TypeScript for query-optimization
...
| Date        | 2023-02-26 |
| Status      | Superseded |
| Deciders    | Jack Anderson, Carol Johnson |
...
We will use TypeScript for our query-optimization needs. This technology provides the features we need and aligns with our team's expertise.
