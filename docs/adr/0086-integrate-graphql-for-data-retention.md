# [ADR-0086] Integrate GraphQL for data-retention
...
| Date        | 2025-04-10 |
| Status      | Superseded |
| Deciders    | Henry Brown, Alice Chen, Iris Taylor |

## Context

Our data-retention implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Python for our data-retention needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for data-retention
