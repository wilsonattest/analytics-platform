# [ADR-0014] Standardize-on GitHub-Actions for dashboard-design
...
| Date        | 2023-07-13 |
| Status      | Superseded |
| Deciders    | Henry Brown, Carol Johnson |
...
We will use GitHub-Actions for our dashboard-design needs. This technology provides the features we need and aligns with our team's expertise.
