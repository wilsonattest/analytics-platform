# [ADR-0019] Implement PostgreSQL for data-export
...
| Date        | 2025-07-24 |
| Status      | Proposed |
| Deciders    | Alice Chen, Carol Johnson, Carol Johnson |
...
We will use Azure-Functions for our data-export needs. This technology provides the features we need and aligns with our team's expertise.
