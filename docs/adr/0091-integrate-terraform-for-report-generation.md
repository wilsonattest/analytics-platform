# [ADR-0091] Integrate Terraform for report-generation
...
| Date        | 2024-01-05 |
| Status      | Accepted |
| Deciders    | Henry Brown, Henry Brown |
...
We will use Terraform for our report-generation needs. This technology provides the features we need and aligns with our team's expertise.
...
### Alternative 2: Use CQRS-pattern

We evaluated using CQRS-pattern. This was not chosen because it added unnecessary complexity for our use case.
