# [ADR-0040] Choose React for query-optimization
...
| Date        | 2024-12-02 |
| Status      | Accepted |
| Deciders    | Jack Anderson, Iris Taylor, Carol Johnson |
...
We will use Kafka for our query-optimization needs. This technology provides the features we need and aligns with our team's expertise.
