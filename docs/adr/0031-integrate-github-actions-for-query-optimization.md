# [ADR-0031] Integrate GitHub-Actions for query-optimization
...
| Date        | 2024-01-16 |
| Status      | Accepted |
| Deciders    | Iris Taylor, Iris Taylor, Eva Martinez |
...
We will use Azure-Functions for our query-optimization needs. This technology provides the features we need and aligns with our team's expertise.
