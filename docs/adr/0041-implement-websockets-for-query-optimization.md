# [ADR-0041] Implement WebSockets for query-optimization
...
| Date        | 2025-01-29 |
| Status      | Proposed |
| Deciders    | Henry Brown, Henry Brown, Bob Smith |

## Context

Our query-optimization implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use DotNet-Core for our query-optimization needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for query-optimization
