# [ADR-0063] Choose GitHub-Actions for etl-pipeline
...
| Date        | 2023-11-24 |
| Status      | Accepted |
| Deciders    | Carol Johnson, Carol Johnson |
...
We will use RabbitMQ for our etl-pipeline needs. This technology provides the features we need and aligns with our team's expertise.
