# [ADR-0013] Use Redis for query-optimization
...
| Date        | 2024-07-17 |
| Status      | Accepted |
| Deciders    | Grace Lee, Bob Smith, David Kim |
...
We will use Python for our query-optimization needs. This technology provides the features we need and aligns with our team's expertise.
