# [ADR-0051] Implement Terraform for real-time-analytics
...
| Date        | 2026-01-01 |
| Status      | Accepted |
| Deciders    | Grace Lee, Iris Taylor, Iris Taylor |
...
We will use REST-API for our real-time-analytics needs. This technology provides the features we need and aligns with our team's expertise.
