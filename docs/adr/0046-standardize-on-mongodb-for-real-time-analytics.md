# [ADR-0046] Standardize-on MongoDB for real-time-analytics
...
| Date        | 2024-10-22 |
| Status      | Accepted |
| Deciders    | Jack Anderson, Bob Smith |
...
We will use Terraform for our real-time-analytics needs. This technology provides the features we need and aligns with our team's expertise.
...
### Alternative 2: Use API-Gateway

We evaluated using API-Gateway. This was not chosen because it added unnecessary complexity for our use case.
