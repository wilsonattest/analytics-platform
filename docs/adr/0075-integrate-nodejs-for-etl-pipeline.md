# [ADR-0075] Integrate Node.js for etl-pipeline
...
| Date        | 2025-09-21 |
| Status      | Proposed |
| Deciders    | Grace Lee, Frank Wilson |
...
We will use Python for our etl-pipeline needs. This technology provides the features we need and aligns with our team's expertise.
