# [ADR-0070] Adopt Elasticsearch for query-optimization
...
| Date        | 2024-07-15 |
| Status      | Proposed |
| Deciders    | Iris Taylor, Carol Johnson |
...
We will use RabbitMQ for our query-optimization needs. This technology provides the features we need and aligns with our team's expertise.
