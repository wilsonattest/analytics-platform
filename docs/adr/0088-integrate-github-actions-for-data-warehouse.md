# [ADR-0088] Integrate GitHub-Actions for data-warehouse
...
| Date        | 2023-11-18 |
| Status      | Proposed |
| Deciders    | David Kim, Eva Martinez, Grace Lee |

## Context

Our data-warehouse implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Azure-Functions for our data-warehouse needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for data-warehouse
