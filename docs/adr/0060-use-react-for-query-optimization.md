# [ADR-0060] Use React for query-optimization
...
| Date        | 2023-07-17 |
| Status      | Accepted |
| Deciders    | Eva Martinez, Frank Wilson |
...
We will use PostgreSQL for our query-optimization needs. This technology provides the features we need and aligns with our team's expertise.
