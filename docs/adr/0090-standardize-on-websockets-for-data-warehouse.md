# [ADR-0090] Standardize-on WebSockets for data-warehouse
...
We will use HashiCorp-Vault for our data-warehouse needs. This technology provides the features we need and aligns with our team's expertise.
