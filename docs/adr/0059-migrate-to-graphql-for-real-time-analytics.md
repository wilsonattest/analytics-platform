# [ADR-0059] Migrate-to GraphQL for real-time-analytics
...
| Date        | 2024-08-24 |
| Status      | Proposed |
| Deciders    | Frank Wilson, Iris Taylor |
...
We will use Node.js for our real-time-analytics needs. This technology provides the features we need and aligns with our team's expertise.
