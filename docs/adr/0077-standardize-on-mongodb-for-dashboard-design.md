# [ADR-0077] Standardize-on MongoDB for dashboard-design
...
We will use Python for our dashboard-design needs. This technology provides the features we need and aligns with our team's expertise.
