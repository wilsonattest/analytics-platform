# [ADR-0058] Use OpenID-Connect for event-tracking
...
| Date        | 2023-06-29 |
| Status      | Deprecated |
| Deciders    | Frank Wilson, Carol Johnson, David Kim |
...
We will use MongoDB for our event-tracking needs. This technology provides the features we need and aligns with our team's expertise.
