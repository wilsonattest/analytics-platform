# [ADR-0073] Switch-to Vue.js for data-export
...
| Date        | 2024-07-15 |
| Status      | Accepted |
| Deciders    | Frank Wilson, Bob Smith, Henry Brown |
...
We will use Docker for our data-export needs. This technology provides the features we need and aligns with our team's expertise.
