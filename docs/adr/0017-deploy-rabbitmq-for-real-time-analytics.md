# [ADR-0017] Deploy RabbitMQ for real-time-analytics
...
| Date        | 2025-11-17 |
| Status      | Accepted |
| Deciders    | Jack Anderson, Henry Brown, Grace Lee |
...
We will use Vue.js for our real-time-analytics needs. This technology provides the features we need and aligns with our team's expertise.
