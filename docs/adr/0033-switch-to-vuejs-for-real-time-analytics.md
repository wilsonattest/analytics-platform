# [ADR-0033] Switch-to Vue.js for real-time-analytics
...
| Date        | 2025-12-19 |
| Status      | Proposed |
| Deciders    | Eva Martinez, Henry Brown, Grace Lee |
...
We will use Docker for our real-time-analytics needs. This technology provides the features we need and aligns with our team's expertise.
