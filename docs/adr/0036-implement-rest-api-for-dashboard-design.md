# [ADR-0036] Implement REST-API for dashboard-design
...
| Date        | 2024-09-17 |
| Status      | Accepted |
| Deciders    | Eva Martinez, Iris Taylor, Frank Wilson |
...
We will use Vue.js for our dashboard-design needs. This technology provides the features we need and aligns with our team's expertise.
