# [ADR-0083] Integrate JWT for report-generation
...
We will use TypeScript for our report-generation needs. This technology provides the features we need and aligns with our team's expertise.
