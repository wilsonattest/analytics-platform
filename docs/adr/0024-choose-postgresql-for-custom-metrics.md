# [ADR-0024] Choose PostgreSQL for custom-metrics
...
| Date        | 2024-07-07 |
| Status      | Superseded |
| Deciders    | Jack Anderson, Henry Brown |
...
We will use Kubernetes for our custom-metrics needs. This technology provides the features we need and aligns with our team's expertise.
