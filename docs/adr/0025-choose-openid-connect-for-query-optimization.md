# [ADR-0025] Choose OpenID-Connect for query-optimization
...
| Date        | 2024-03-14 |
| Status      | Accepted |
| Deciders    | Alice Chen, Jack Anderson, Eva Martinez |
...
We will use OpenID-Connect for our query-optimization needs. This technology provides the features we need and aligns with our team's expertise.
