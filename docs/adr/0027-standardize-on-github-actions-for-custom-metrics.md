# [ADR-0027] Standardize-on GitHub-Actions for custom-metrics
...
| Date        | 2023-10-02 |
| Status      | Deprecated |
| Deciders    | Carol Johnson, Bob Smith, Frank Wilson |
...
We will use OpenID-Connect for our custom-metrics needs. This technology provides the features we need and aligns with our team's expertise.
