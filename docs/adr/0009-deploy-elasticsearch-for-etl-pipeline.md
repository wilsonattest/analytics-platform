# [ADR-0009] Deploy Elasticsearch for etl-pipeline
...
| Date        | 2024-11-29 |
| Status      | Superseded |
| Deciders    | Carol Johnson, Bob Smith, Henry Brown |
...
We will use OpenID-Connect for our etl-pipeline needs. This technology provides the features we need and aligns with our team's expertise.
