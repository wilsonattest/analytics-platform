# [ADR-0011] Integrate Docker for custom-metrics
...
| Date        | 2023-05-30 |
| Status      | Accepted |
| Deciders    | Eva Martinez, David Kim, Alice Chen |

## Context

Our custom-metrics implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Redis for our custom-metrics needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for custom-metrics
