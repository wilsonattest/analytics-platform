# [ADR-0004] Migrate-to OAuth-2.0 for event-tracking
...
| Date        | 2023-03-19 |
| Status      | Accepted |
| Deciders    | Carol Johnson, Henry Brown |
...
We will use Kafka for our event-tracking needs. This technology provides the features we need and aligns with our team's expertise.
