# [ADR-0071] Switch-to Kubernetes for report-generation
...
| Date        | 2025-10-16 |
| Status      | Accepted |
| Deciders    | Carol Johnson, Grace Lee, Alice Chen |

## Context

Our report-generation implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Kafka for our report-generation needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for report-generation
